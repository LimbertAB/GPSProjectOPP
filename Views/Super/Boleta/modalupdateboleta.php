				   	...
				   	<form autocomplete="off">
						...
						<div class="form-group" style="margin-bottom:10px">
							...
							<div class='input-group'>
								<select id="selectresponsable_u" class="form-control selectpicker show-tick" multiple data-live-search="true" data-max-options="4" data-selected-text-format="count > 2">
