	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-12">
	          <ul class="nav nav-tabs nav-justified" id="myTabs">
	               <li role="presentation" class="active"><a href="#todos" aria-controls="todos" role="tab" data-toggle="tab">TODOS<span class="badge" style="background:<?php echo COLOR?>;margin-left:10px;color:#fff"><?php echo mysql_num_rows($resultado["vehiculos"]);?></span></a></li>
