<div class="modal fade" id="newchoferModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				...
				<form  class="form-horizontal" autocomplete="off">
					<div class="row"  style="margin-left:40px;margin-right:40px;margin-top:25px;margin-bottom:25px">
						<div class="form-group  has-feedback has-error fila1">
							...
							<div class="col-sm-10">
								<input type="text" id="inputnombre" required class="form-control" placeholder="Ejemplo: Nicanor Condori Vargas" validate=true toggle=".fila1">
								<span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden=true></span>
							</div>
						</div>
						<div class="form-group  has-feedback has-error fila2">
							<label class="col-sm-2 control-label">Brevet</label>
							<div class="col-sm-10">
								<input type="text" min="1" id="inputbrevet" autocomplete="false" class="form-control" placeholder="Ejemplo: 3690439 C" validate=true toggle=".fila2">
								<span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
								<em style="color:#cf6666;display:none" id="error_registro">El Numero de brevet ya esta en uso!</em>
							</div>
						</div>
