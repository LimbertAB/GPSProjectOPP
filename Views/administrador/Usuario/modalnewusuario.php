				...
				<form  class="form-horizontal" autocomplete="off">
					<div class="row"  style="margin-left:40px;margin-right:40px;margin-top:25px;margin-bottom:25px">
						...
						<div class="form-group  has-feedback has-error fila3">
							...
							<div class="col-sm-10">
								<input type="number" min="1" name="ci" id="inputci" autocomplete="false" class="form-control" placeholder="Ejemplo: 5570221" validate=true toggle=".fila3">
								<span class="glyphicon glyphicon-remove form-control-feedback" aria-hidden="true"></span>
						...
						<div class="form-group has-feedback has-error fila4">
							...
							<div class="col-sm-10">
								<input type="password" name="password" id="inputpassword" autocomplete="false" class="form-control" placeholder="Minimo 5 caracteres" validate="true"  toggle=".fila4">
