...
<div class="row">
	<div class="col-md-9">
		<h2 class="text-center" style="margin:5px 0 1px 0;font-weight:300">LISTA DE INSTRUCTIVOS <small> (<?php echo $mes."-".$resultado['year'];?>)</small> </h2>
	</div>
	<div class="col-md-2">
    ...
    $(document).ready(function(){
	    $('#datetimepickermes1').datetimepicker({locale: 'es',format: 'YYYY-MM',ignoreReadonly: true,viewMode: 'months'}).on('dp.change', function(e){
		    ...
		    if (placeholder.toString()!=input.toString()) {
			    window.location.href = "/<?php echo FOLDER;?>/Instructivo?date="+e.date._d.getFullYear()+au;
		    }
	    });
