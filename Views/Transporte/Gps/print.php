...
<html>
     <head>
          ...
          <script src="<?php echo URL;?>public/js/jspdf.min.js"></script>
          <script src="<?php echo URL;?>public/js/jspdf.debug.js"></script>
          <script src="<?php echo URL;?>public/js/jspdfpluginautotable.js"></script>
     </head>
     <body >
          <a href="javascript:imprimir()">Download PDF</a>
          <button type="button" name="button" onclick="imprimir()">click</button>
          <script>
               var lines=[],contadortotal=0,total=0,contador=0,locations=[],isPaused = true,descripciones=[];
               var
               function imprimir(){
                    var database = <?php echo json_encode($resultado['filename'])?>;
                    if (database) {
                         $.get('<?php echo URL?>locations/'+database+'', function(data) {
                    ...
                    function READ_LOCATION(locations){
                         ...
                         console.log("ultimo contador",contador," total", total);
                         ...
                         var imgData = 'data:image/jpeg;base64,';
                                                  ...
                                                  doc.text(39, 30, 'Nombre del chofer.');
                                                  doc.text(42, 35, 'tipo y placa del vehiculo.');
                                                  doc.text(35, 40, lines[0][4]);
                                                  doc.text(30, 45, lines[lines.length-1][4]);
                                                  doc.text(121, 30, '2018-04-12');
                                                  doc.text(135, 35, 'decripcion del recorrido');
                                                  ...
                                                  doc.save('Test.pdf');
                                                 // var u=doc.output('datauri');
                                                 // console.log(URL.createObjectURL(u));
                                                 // window.open("data:application/octet-stream;charset=utf-16le;base64,"+u);
                                                 //window.open("data:application/pdf," + encodeURI(u));
          ...
          <center><h3>REPORTE DE VIAJE</h3></center>
          <div id="customers">
               <table width="100%" style="margin-top:20px" cellspacing="0" cellpadding="0" id="">
                    <tr>
                         <td width="55%"><h5 style="margin-left:50px;text-align:left">CHOFER: <small><?php echo $resultado['nombre']." (".$resultado['brevet'].")"?></small> </h5></td>
                         <td width="45%"><h5 style="text-align:left">FECHA: <small><?php echo $resultado['fecha']?></small> </h5></td>
                    </tr>
                    <tr>
                         <td><h5 style="margin-left:50px;text-align:left">VEHICULO: <small><?php echo $resultado['tipo']." (".$resultado['placa'].")"?></small> </h5></td>
                         <td><h5 style="text-align:left">DESCRIPCIÓN: <small><?php echo $resultado['descripcion']?></small> </h5></td>
                    </tr>
                    <tr>
                         <td><h5 style="margin-left:50px;text-align:left">INICIO: <small><?php echo $resultado['tipo']." (".$resultado['placa'].")"?></small> </h5></td>
                         <td><h5 style="text-align:left">FIN: <small><?php echo $resultado['descripcion']?></small> </h5></td>
                    </tr>
               </table>
          </div>
          <div id="customers">
