...
<html>
     ...
     <body >
          ...
          <table width="100%" style="margin-top:60px">
               ...
               <tr><?php $session=Session::getSession('Usuario');?>
                    <td align="center" style="text-transform:uppercase">SR. <?php echo $session['nombre']?><BR><b>RESPONSABLE DE TRASPORTES</b></td>
                    <td align="center" style="text-transform:uppercase"><?php  echo  $resultado['administradora']['nombre']==null?"ADMINISTRADORA NO ENCONTRADA":"LIC. ".$resultado['administradora']['nombre']?><br><b>RESPONSABLE DE LA UNIDAD ADMINISTRATIVA</b></td>
               </tr>
          </table>
     </body>
</html>
