     ...
     <body >
          ...
          <table width="100%" style="margin-top:20px"  width="100%" cellspacing="0" cellpadding="0" id="tableborder">
               <thead style="background:#bdbdbd;text-align:center">
                    <tr>
                         <td width="18%" rowspan="2">VEHICULO</td>
                         <td width="20%" rowspan="2">NOMBRE DEL CONDUCTOR</td>
                         <td width="11%" rowspan="2">LUGARES DE VISITA / MUNICIPIOS</td>
                         <td width="11%" rowspan="2">ACTIVIDAD</td>
                         <td width="10%" rowspan="2">JEFATURA Y/O UNIDAD</td>
                         <td width="20%" rowspan="2">RESPONSABLES</td>
               ...
               <tbody>
                    ...
                    <?php for($i=0;$i< count($resultado['boletas']);$i++){?>
                         <tr>
                              ...
                              <td  style="text-transform: lowercase"><h5 style="line-height: 1em;"><?php echo $resultado['boletas'][$i]['lugares']; ?></h5></td>
          ...
          <table width="100%" style="margin-top:60px">
               ...
               <tr>
                    <td align="center">SR. JHONNY RIVERA MORALES<BR><b>RESPONSABLE DE TRASPORTES</b></td>
                    <td align="center">LIC. LILIAN TANUZ GONZALES<br><b>RESPONSABLE DE LA UNIDAD ADMINISTRATIVA</b></td>
               </tr>
          </table>
     </body>
</html>
